...
struct ContextualInsightCompactCard: View {
    ...
    private var icon: String { switch insight.type { case .overdueReminder: "exclamationmark.triangle.fill"; case .upcomingReminder: "bell.badge"; case .calendarPeriod: "calendar.badge.clock"; case .odometerUpdate: "gauge.with.needle"; case .seasonalGuidance: "sun.max"; case .missingDocument: "doc.text"; case .monthlyExpensePrompt: "turkishlirasign.circle"; case .fuelTypeGuidance: "fuelpump"; case .transmissionGuidance: "gearshape.2"; case .odometerMilestone: "flag.checkered"; case .maintenance: "wrench.and.screwdriver"; case .quietGoodState: "checkmark.seal"; case .saleFileReadiness: "doc.richtext"; case .predictiveOdometer: "brain.head.profile"; case .predictiveMaintenance: "brain.head.profile" } }
}
