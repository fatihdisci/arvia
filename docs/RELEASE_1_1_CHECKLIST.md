...
- [ ] Vercel Production ortamında şu değişkenler doğrulansın:
  `DEEPSEEK_API_KEY`, `ARVIA_CLIENT_SECRET`, `ARVIA_APP_SHARED_SECRET`,
  `ARVIA_BUNDLE_ID=com.ruhsatim.app`, `UPSTASH_REDIS_REST_URL`,
  `UPSTASH_REDIS_REST_TOKEN`.
- [ ] Global günlük tavanlar bütçeye göre açıkça ayarlansın:
  `GLOBAL_DAILY_RECEIPT_LIMIT`, `GLOBAL_DAILY_MAINTENANCE_LIMIT`.
- [ ] Önce Vercel preview dağıtımı yapılsın; geçerli Sandbox Pro makbuzuyla iki
  görev de test edilsin.
- [ ] Eksik/bozuk makbuz 403, yanlış secret 401, büyük payload/receipt 413,
...
> Önemli uyumluluk notu: 1.0.1 istemcisi `appReceipt` göndermez. Sertleştirilmiş
